...
public class CalcV4 extends JFrame implements ActionListener {

    JButton b1, b2, b3, b4, b5, b6, b7, b8, b9, b0, add, subtract, multiply, divide, equals;
    ...
    public CalcV4() {
	super("Calculator");
	setSize(450,400);           //modified size
        setDefaultCloseOperation(EXIT_ON_CLOSE);    //make it close properly
	//create buttons
        numPad = new JPanel();
        numPad.setLayout(new GridLayout(4, 3));     //set grid layout for buttons
        operPad = new JPanel();
        operPad.setLayout(new GridLayout(4, 1));
